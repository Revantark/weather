...
export default function Navbar() {
    ...
    return (
        <nav className="flex md:flex-row sm:flex-col   justify-around mt-8 text-xl    	 ">
            <Link className={`${currentWeather.currentWeather ? 'pointer-events-none opacity-40' : ''} sm:pb-5 self-center justify-self-center`} to="/" >{currentWeather.currentWeather ? currentWeather.location : "Current Location Weather"}</Link>
            <div className="justify-self-center self-center">
                <form className="flex">
                    ...
                    <button className="self-center justify-self-center btn bg-gray-300 focus:ring-1 focus:ring-gray-400 hover:bg-gray-400" onClick={submitCity} >
